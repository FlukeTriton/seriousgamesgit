...
func makeliterallyeverythinginvisiblelol():
	...
	#Tag4
	$ScrollContainer/VBoxContainer/Trenner4_1.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_2.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_1.visible = false
	$ScrollContainer/VBoxContainer/Trenner4_2.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_3.visible = false
	$ScrollContainer/VBoxContainer/Trenner4_3.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_4.visible = false
	$ScrollContainer/VBoxContainer/Trenner4_4.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_5.visible = false
	$ScrollContainer/VBoxContainer/Trenner4_5.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_6.visible = false
	$ScrollContainer/VBoxContainer/Trenner4_6.visible = false
	$ScrollContainer/VBoxContainer/Beitrag4_7.visible = false
	#Tag5
	$ScrollContainer/VBoxContainer/Beitrag5_1.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_1.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_2.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_2.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_3.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_3.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_4.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_4.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_5.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_5.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_6.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_6.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_7.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_7.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_8.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_8.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_9.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_9.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_10.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_10.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_11.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_11.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_12.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_12.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_13.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_13.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_14.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_14.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_15.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_15.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_16.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_16.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_17.visible = false
	$ScrollContainer/VBoxContainer/Trenner5_17.visible = false
	$ScrollContainer/VBoxContainer/Beitrag5_18.visible = false
...
func _ready():
	...
	if GameManager.current_day == 5:
		if GameManager.Tag5_Tweet_Anzahl >= 1:
			$ScrollContainer/VBoxContainer/Beitrag5_1.visible = true
			$ScrollContainer/VBoxContainer/Trenner5_1.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 2:
			$ScrollContainer/VBoxContainer/Beitrag4_2.visible = true
			$ScrollContainer/VBoxContainer/Trenner4_2.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 3:
			$ScrollContainer/VBoxContainer/Beitrag5_3.visible = true
			$ScrollContainer/VBoxContainer/Trenner5_3.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 4:
			$ScrollContainer/VBoxContainer/Beitrag5_4.visible = true
			$ScrollContainer/VBoxContainer/Trenner5_4.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 5:
			$ScrollContainer/VBoxContainer/Beitrag5_5.visible = true
			$ScrollContainer/VBoxContainer/Trenner5_5.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 6:
			$ScrollContainer/VBoxContainer/Trenner5_6.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_6.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 7:
			$ScrollContainer/VBoxContainer/Beitrag5_7.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_7.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 8:
			$ScrollContainer/VBoxContainer/Beitrag5_8.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_8.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 9:
			$ScrollContainer/VBoxContainer/Beitrag5_9.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_9.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 10:
			$ScrollContainer/VBoxContainer/Beitrag5_10.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_10.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 11:
			$ScrollContainer/VBoxContainer/Beitrag5_11.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_11.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 12:
			$ScrollContainer/VBoxContainer/Beitrag5_12.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_12.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 13:
			$ScrollContainer/VBoxContainer/Beitrag5_13.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_13.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 14:
			$ScrollContainer/VBoxContainer/Beitrag5_14.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_14.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 15:
			$ScrollContainer/VBoxContainer/Beitrag5_15.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_15.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 16:
			$ScrollContainer/VBoxContainer/Beitrag5_16.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_16.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 17:
			$ScrollContainer/VBoxContainer/Beitrag5_17.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_17.visible = true
		if GameManager.Tag5_Tweet_Anzahl >= 18:
			$ScrollContainer/VBoxContainer/Beitrag5_18.visible = true
			$ScrollContainer/VBoxContainer/Beitrag5_18.visible = true
